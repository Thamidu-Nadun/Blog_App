...
if (isset($_POST['form1'])) {
    ...
    if ($valid == 1) {
        ...
        $statement = $pdo->prepare("UPDATE setting SET logo=? WHERE id=1");
...
if (isset($_POST['form2'])) {
    ...
    if ($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE setting SET favicon=? WHERE id=1");
        $statement->execute(array($final_name));
...
if (isset($_POST['form3'])) {
    ...
    // updating the database
    $statement = $pdo->prepare("UPDATE setting SET newsletter_on_off=?, footer_copyright=?, contact_address=?, contact_email=?, contact_phone=?, contact_map_iframe=? WHERE id=1");
...
if (isset($_POST['form4'])) {
    // updating the database
    $statement = $pdo->prepare("UPDATE setting SET receive_email=?, receive_email_subject=?,receive_email_thank_you_message=?, forget_password_message=? WHERE id=1");
...
if (isset($_POST['form5'])) {
    $statement = $pdo->prepare("UPDATE admin SET name=?, description=?, image=?, nickname=? WHERE id=1");
    $statement->bindParam(1, $_POST['hero_user_name'], PDO::PARAM_STR);
    $statement->bindParam(2, $_POST['hero_user_description'], PDO::PARAM_STR);
    $statement->bindParam(3, $_POST['hero_user_img_link']);
    $statement->bindParam(4, $_POST['hero_user_nick_name'], PDO::PARAM_STR);
    $statement->execute();

    $success_message = 'Hero settings is updated successfully.';
}


if (isset($_POST['form6_0'])) {
    // updating the database
    $statement = $pdo->prepare("UPDATE setting SET home_service_on_off=?, home_welcome_on_off=?, home_featured_product_on_off=?, home_latest_product_on_off=?, home_popular_product_on_off=? WHERE id=1");
...
if (isset($_POST['form6'])) {
    // updating the database
    $statement = $pdo->prepare("UPDATE setting SET meta_title_home=?, meta_keyword_home=?, meta_description_home=? WHERE id=1");
...
if (isset($_POST['form6_7'])) {
    ...
    if ($valid == 1) {
        ...
        if ($path != '') {
            ...
            // updating the database
            $statement = $pdo->prepare("UPDATE setting SET cta_title=?,cta_content=?,cta_read_more_text=?,cta_read_more_url=?,cta_photo=? WHERE id=1");
            $statement->execute(array($_POST['cta_title'], $_POST['cta_content'], $_POST['cta_read_more_text'], $_POST['cta_read_more_url'], $final_name));
        } else {
            // updating the database
            $statement = $pdo->prepare("UPDATE setting SET cta_title=?,cta_content=?,cta_read_more_text=?,cta_read_more_url=? WHERE id=1");
...
if (isset($_POST['form6_4'])) {
    ...
    if ($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE setting SET featured_product_title=?,featured_product_subtitle=? WHERE id=1");
...
if (isset($_POST['form6_5'])) {
    ...
    if ($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE setting SET latest_product_title=?,latest_product_subtitle=? WHERE id=1");
...
if (isset($_POST['form6_6'])) {
    ...
    if ($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE setting SET popular_product_title=?,popular_product_subtitle=? WHERE id=1");
...
if(isset($_POST['form6_1'])) {
    ...
    if($valid == 1) {
        ...
        if($path != '') {
            ...
            // updating the database
            $statement = $pdo->prepare("UPDATE setting SET testimonial_title=?,testimonial_subtitle=?, testimonial_photo=? WHERE id=1");
            $statement->execute(array($_POST['testimonial_title'],$_POST['testimonial_subtitle'],$final_name));
        } else {
            // updating the database
            $statement = $pdo->prepare("UPDATE setting SET testimonial_title=?,testimonial_subtitle=? WHERE id=1");
...
if(isset($_POST['form6_2'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE setting SET blog_title=?,blog_subtitle=? WHERE id=1");
...
if (isset($_POST['form6_3'])) {
    ...
    // updating the database
    $statement = $pdo->prepare("UPDATE setting SET newsletter_text=? WHERE id=1");
...
if (isset($_POST['form7_1'])) {
    ...
    if ($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE setting SET banner_login=? WHERE id=1");
        $statement->execute(array($final_name));
...
if (isset($_POST['form7_2'])) {
    ...
    if ($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE setting SET banner_registration=? WHERE id=1");
        $statement->execute(array($final_name));
...
if (isset($_POST['form7_3'])) {
    ...
    if ($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE setting SET banner_forget_password=? WHERE id=1");
        $statement->execute(array($final_name));
...
if (isset($_POST['form7_4'])) {
    ...
    if ($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE setting SET banner_reset_password=? WHERE id=1");
        $statement->execute(array($final_name));
...
if (isset($_POST['form7_6'])) {
    ...
    if ($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE setting SET banner_search=? WHERE id=1");
        $statement->execute(array($final_name));
...
if (isset($_POST['form7_7'])) {
    ...
    if ($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE setting SET banner_cart=? WHERE id=1");
        $statement->execute(array($final_name));
...
if (isset($_POST['form7_8'])) {
    ...
    if ($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE setting SET banner_checkout=? WHERE id=1");
        $statement->execute(array($final_name));
...
if (isset($_POST['form7_9'])) {
    ...
    if ($valid == 1) {
        ...
        // updating the database
        $statement = $pdo->prepare("UPDATE setting SET banner_product_category=? WHERE id=1");
        $statement->execute(array($final_name));
...
if (isset($_POST['form7_10'])) {
    ...
    /*
        if($valid == 1) {
            ...
            // updating the database
            $statement = $pdo->prepare("UPDATE setting SET banner_blog=? WHERE id=1");
            $statement->execute(array($final_name));
...
if (isset($_POST['form9'])) {
    // updating the database
    $statement = $pdo->prepare("UPDATE setting SET paypal_email=?, bank_detail=? WHERE id=1");
...
if (isset($_POST['form10'])) {
    // updating the database
    $statement = $pdo->prepare("UPDATE setting SET before_head=?, after_body=?, before_body=? WHERE id=1");
...
if(isset($_POST['form11'])) {
    // updating the database
    $statement = $pdo->prepare("UPDATE setting 
                            SET 
        ...
        <div class="col-md-12">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#tab_5" data-toggle="tab">Hero Setting</a></li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab_5">
                        ...
                        if ($result) {
                            $id = $result['id'];
                            $hero_user_name = $result['name'];
                            $hero_user_img_link = $result['image'];
                            $hero_user_description = $result['description'];
                            $hero_user_nick_name = $result['nickname'];
                        } else {
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" name="hero_user_name"
                                                value="<?php echo $hero_user_name; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Description<span>*</span></label>
                                        <div class="col-sm-6">
                                            <textarea class="form-control" name="hero_user_description"
                                                style="height:140px;"><?php echo $hero_user_description; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Image URL<span>*</span></label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" name="hero_user_img_link"
                                                value="<?php echo $hero_user_img_link; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Nick Name<span>*</span></label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" name="hero_user_nick_name"
                                                value="<?php echo $hero_user_nick_name; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
